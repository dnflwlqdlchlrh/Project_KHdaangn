	...
	<form action="${jobMod}" method="post" enctype="multipart/form-data">
		<div class="main-wrap">
			...
			<div class="add-title">
				...
				<input type="text" name="title" value="${detailInfo.title}" placeholder="구인 내용 요약">
			</div>
			<div class="add-info">
				<h3>정보</h3>
				<select name="payType">
				...
				<input placeholder="9,160" type="text" name="pay" value="${detailInfo.pay}" onKeyup="this.value=this.value.replace(/[^0-9]/g,'')">원
			</div>
			<div class="add-week">
				<h3>일하는 요일</h3>
			...
			상호명<input placeholder="상호명" type="text" name="companyName" value="${detailInfo.companyName}">	
			주소<input placeholder="주소" id="address" type="text" name="address" value="${detailInfo.address}" onClick="addAddress()">
			<input type="hidden" id="addressCode" type="text" name="addressCode" value="${detailInfo.addressCode}">
			<input type="hidden" id="addressName" type="text" name="addressName" value="${detailInfo.addressName}">
			사용자id<input class="ptjob-add-input" type="text" name="userId" value="${jobInfo.userId}">
			<div class="add-detail">
				<h3>상세정보</h3>
				<input type="text" name="detail" value="${detailInfo.detail}" placeholder="예) 업무 예시, 근무 여건, 지원자가 갖추어야 할 능력, 우대 사항 등">
			</div>
